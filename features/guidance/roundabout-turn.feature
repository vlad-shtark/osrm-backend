...
Feature: Basic Roundabout
    ...
    Scenario: Enter and Exit -- Bearing
       ...
       When I route I should get
           ...
           | a,d       | ab,cd,cd | depart,roundabout turn left exit-3,arrive     | 0->180,180->223,90->0  |
           | a,f       | ab,ef,ef | depart,roundabout turn straight exit-2,arrive | 0->180,180->223,180->0 |
           | a,h       | ab,gh,gh | depart,roundabout turn right exit-1,arrive    | 0->180,180->223,270->0 |
